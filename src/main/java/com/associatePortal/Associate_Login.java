...
{	
	...
	{		
		...
		{			
			...
			Assert.assertEquals(getText("//*[@id='login-panel']/div/div[2]/div[1]"), "Username was not found.");			
		} 
		catch (Exception e) 
		{
			Assert.fail(e.getMessage());
	...
	{		
		...
		{			
			...
			Assert.assertEquals(getText("//div[@class='text-danger au-target']"), "Invalid username or password.");
