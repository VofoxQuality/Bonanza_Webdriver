...

{
	...
	public void TCBA01101()
	{
		try 
		{
			...
			wt.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//span[@class='username']"))));
			
			//Assert Username  is present on the Home page
	...
	public void TCBA01102()
	{
		try
		{
			...
			//To check the drill down functionality and its properly redirect to the corresponding pages.
			Assert.assertTrue(driver.getTitle().contentEquals("My Downline | 5-15")," title My Downline | 5-15 not found");
			
			//To verify the page displayed header text "Summary" in the My downline.
